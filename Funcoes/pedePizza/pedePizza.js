...
frm.inDetalhes.addEventListener("focus", () => {
    if (frm.rbPizza.checked) { // se radio pizza is checked
        const pizza = frm.inPizza.value // obter valor do seletor
        const num = pizza == "media" ? 2 : pizza == "grande" ? 3 : 4
        // atributo placeholder coloca dica de preenchimento dentro do campo
